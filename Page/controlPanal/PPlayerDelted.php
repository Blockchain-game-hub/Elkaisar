                ...
                <div id="center-column">
                    ...
                    <div class="table"> 
                        ...
                        <table id="user-table" class="listing" cellpadding="0" cellspacing="0">
                            ...
                            $all_member = selectFromTable("*", "player_transfer", "1 ORDER BY prestige DESC LIMIT 15 OFFSET $page_num");
                            $pages = selectFromTable("COUNT(*) AS m_count", "player_transfer", "1");
                            ...
                            foreach ($all_member  as $one){
                                ...
                                echo '  <tr data-id-player="'.$one["id_player"].'">
                                            ...
                                            <td class="restore-player"  data-player-name="'.$one['name'].'"  data-id-player="'.$one["id_player"].'">   <img src="../img/save-icon.gif" width="16" height="16" alt="" /></td>
                                        </tr>';
